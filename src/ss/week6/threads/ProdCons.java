...
public class ProdCons {
	public static void main(String[] args) {
		...
		IntCell goodcell = new GoodIntCell();
		IntCell fincell = new FinegraineddIntCell();
		Thread prod1 = new Thread(new IntProducer(1, fincell), "Producer 1");
		Thread prod2 = new Thread(new IntProducer(2, fincell), "Producer 2");
		Thread cons1 = new Thread(new IntConsumer(1, fincell), "Consumer 1");
		Thread cons2 = new Thread(new IntConsumer(2, fincell), "Consumer 2");
