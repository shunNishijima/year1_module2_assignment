...
/**
 * Exam2.A server for the streaming calculator. Classes that implement this interface offer the calculator service
 ...
 */
public interface CalculatorServer extends Runnable {
    /**
